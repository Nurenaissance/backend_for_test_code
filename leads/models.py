...
class Lead(models.Model):
    ...
    # assigned_to = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='Leads_assigned_to',blank=True,null=True)    
    ...
    custom_fields = models.ManyToManyField(CustomField, blank=True, related_name='lead_custom_fields')
    def __str__(self):
